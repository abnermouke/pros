...
/**
 * 图片（多图）上传构建器
 * Class PicturesBuilder
 * @package Abnermouke\Pros\Builders\Form\Tools\Items
 */
class PicturesBuilder extends BasicBuilder
{

    /**
     * 构造函数
     * PicturesBuilder constructor.
     * @param $field
     * @param $guard_name
     * @throws \Exception
     */
    ...
    {
        //引入父级构造
        parent::__construct('pictures', $field, $guard_name);
        //设置基础信息
    ...
    /**
     * 设置是否裁剪（需裁剪每次仅可上传一张图，不裁剪一次性可选择多张图）
     * @Author Abnermouke <abnermouke@outlook.com>
     * @Originate in Abnermouke's MBP
