...
class ProsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            ...
            __DIR__.'/Commands/Application/UpdateCommand.php' => app_path('Console/Commands/Application/UpdateCommand.php'),
            __DIR__.'/Commands/Pros/Tasks/TemporaryFileCommand.php' => app_path('Console/Commands/Pros/Tasks/TemporaryFileCommand.php'),
            __DIR__.'/Commands/Pros/Tasks/QueryAmapAreaCommand.php' => app_path('Console/Commands/Pros/Tasks/QueryAmapAreaCommand.php'),
